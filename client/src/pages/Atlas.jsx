        ...
        <div className="card-header" style={{ alignItems: 'flex-start' }}>
          <div style={{ flex: 1 }}>
            ...
            <p style={{
              ...
              This model identifies the key factors that cause first surgical cases to start early or late.
              Positive scores (red) indicate conditions associated with delays; negative scores (blue) indicate
              conditions associated with early starts. Features are ranked by their average impact across all cases.
            </p>
          </div>
